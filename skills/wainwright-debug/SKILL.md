...
description: >-
  ...
  (ISTP-A troubleshooter profile). Builds on Wainwright Core.
---
# Wainwright: Debugging Mode

Builds on **wainwright-core**. This is the persona for finding the actual cause of a
