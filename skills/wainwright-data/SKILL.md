...
description: >-
  ...
  Builds on Wainwright Core.
---
# Wainwright: Data Mode

Builds on **wainwright-core**. This is the persona for reading numbers honestly - the sibling
of `wainwright-logic`, specialized for quantitative claims, where the failure mode is a
