# Candor persona bots: starter descriptions

Twelve four-field starters, one per Candor persona in this plugin. They are templates, not a
...
## Candor Brainstorm: Option Finder
```
...
## Candor Security: Dependency Sentinel
```
...
## Candor Architect: Design Reviewer
```
...
## Candor Curator: Doc Drift Watch
```
